...
public interface SurveyMapper {
	...
	//입력
	public void insUserAnswer(UserAnswerVO vo);
	...
	//관리자 설문조사등록
	public void inputSurvey(SurveyVO vo);
	//질문 문항 등록
	public void inputSurveyQues(QuestionVO vo);
	//옵션 등록
	public void inputAnsOption(AnswerVO vo);
