		...
		<div class="card mb-4">
			<div class="card-body">
				...
				<c:if test="${galPost.writer eq loginId}">
					<button class="btn btn-outline-warning" onclick="location.href='/galary/galaryPostEditFrm.do?galary_id=${galPost.galary_id}'">수정하기</button>
...
<script type="text/javascript">
	...
	function goList(){
		...
		location.href="/galary/galaryList.do?&category="+category+"&cntPerPage="+cntperpage+"&nowPage="+nowpage+"&search_type="+searchtype+"&search_word="+searchword;
